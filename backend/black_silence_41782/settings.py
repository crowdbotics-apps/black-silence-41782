"""
Django settings for black_silence_41782 project.
...
ROOT_URLCONF = 'black_silence_41782.urls'
...
WSGI_APPLICATION = 'black_silence_41782.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "black_silence_41782 API",
    "DESCRIPTION": "API documentation for black_silence_41782 App",
    "VERSION": "v1",
}
